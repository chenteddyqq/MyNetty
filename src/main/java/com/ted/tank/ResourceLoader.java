...
public class ResourceLoader {
    ...
    static {
        try {
            goodtankU = ImageIO.read(new FileInputStream("images/Goodtank1.png"));
            goodtankL = ImageUtil.rotateImage(goodtankU,-90);
            goodtankR = ImageUtil.rotateImage(goodtankU,90);
            goodtankD = ImageUtil.rotateImage(goodtankU,180);
            goodtankU1 = ImageIO.read(new FileInputStream("images/Goodtank2.png"));
            ...
            badtankU = ImageIO.read(new FileInputStream("images/Badtank1.png"));
            badtankL = ImageUtil.rotateImage(badtankU,-90);
            badtankR = ImageUtil.rotateImage(badtankU,90);
            badtankD = ImageUtil.rotateImage(badtankU,180);
            badtankU1 = ImageIO.read(new FileInputStream("images/Badtank2.png"));
            ...
            bulletU = ImageIO.read(new FileInputStream("images/bulletU.png"));
            bulletL = ImageUtil.rotateImage(bulletU,-90);
            bulletR = ImageUtil.rotateImage(bulletU,90);
            bulletD = ImageUtil.rotateImage(bulletU,180);

            for(int i=0;i<16;i++){
                explodes[i]=ImageIO.read(new FileInputStream("images/e" +(i+1)+".gif"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
